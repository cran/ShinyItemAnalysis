...
```
## Version
Current version available on [**CRAN**](https://CRAN.R-project.org/package=ShinyItemAnalysis) is 1.2.6. Version available [**online**](https://shiny.cs.cas.cz/ShinyItemAnalysis/) is 1.2.6. The newest development version available on [**GitHub**](https://github.com/patriciamar/ShinyItemAnalysis) is 1.2.6.
